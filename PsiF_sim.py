...
if __name__ == '__main__':
    ...
    plpsi.plot_sim_phase(opt.statename+'.npy', './figures/Psi_f.png', opt.nlab, ncut0=opt.ncut0, ncut1=opt.ncut1, nsig0=opt.nsig0, nsig1=opt.nsig1, fmin=opt.fmin, fmax=opt.fmax, m1=opt.m1, m2=opt.m2, Tfrac=opt.Tfrac, beta=opt.beta, sig=opt.sig)
